...
async function fetchSuggestedLaptops(featuredLaptop: Product): Promise<Product[]> {
...
export function HomepageContent() {
  ...
  useEffect(() => {
    async function loadSuggestions() {
      const suggestions = await fetchSuggestedLaptops(featuredLaptop);
      setSuggestedLaptops(suggestions);
    }
    loadSuggestions();
  }, [featuredLaptop]);
  ...
  // Handler for peripherals selection
  const handleSelectPeripheral = (product: Product, selected: boolean) => {
    if (selected) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          <div className="lg:col-span-2 space-y-12">
            ...
            <section>
              ...
              <PeripheralsSelection peripherals={peripheralData} onSelect={handleSelectPeripheral} />
            </section>
          </div>

          <div className="lg:col-span-1 sticky top-8 max-h-[calc(100vh-2rem)] overflow-y-auto">
